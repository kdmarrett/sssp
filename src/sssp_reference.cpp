...
void computation_unit(uint1* terminate, int2* update_sginal, data_i* s, data_i* d, data_v* weights, data_v* dist_s, data_v* dist_d, int2* update_signal4, data_v* update_values4, data_i* s4, data_i* d4){
#pragma HLS inline off 
...
#pragma HLS INTERFACE s_axilite port=nlocaledges bundle=control
#pragma HLS INTERFACE s_axilite port=nlocalvertices bundle=control
#pragma HLS INTERFACE s_axilite port=root bundle=control
...
#pragma HLS INTERFACE s_axilite port=return bundle=control
    ...
    #pragma HLS array_partition variable=dist_local cyclic factor=8 // ?? check to see if you can use complete
